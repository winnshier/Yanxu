...
const labels: Record<TaskStatus, string> = {
  ...
  ARCHIVED: '已归档', CANCELLED: '已废弃', REOPENED: '已重新打开',
};

const colors: Partial<Record<TaskStatus, string>> = {
  RUNNING: 'processing', VALIDATING: 'cyan', DELIVERED: 'success', ARCHIVED: 'default', CANCELLED: 'default', BLOCKED: 'error', STOPPED: 'default',
